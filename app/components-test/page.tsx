  ...
  return (
    <div className="min-h-screen text-[var(--color-ink)]">
      {/* C.6 / C.7: Preloader + RouteCurtain are mounted globally in app/layout.tsx (R1.D).
          R1.7.D: outer bone bg removed so the global ScrollBackdrop canvas shows through.
          Sections that need a bone ground now declare it explicitly. */}

      <header className="bg-[var(--color-bone)] px-[5vw] pt-32 pb-16">
