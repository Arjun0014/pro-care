          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
              {[
                ...
                <div key={i} className="group flex flex-col gap-5 border-t border-[var(--color-ink)]/15 pt-8 hover:border-[var(--color-gold)] transition-colors duration-300">
                  <div className="w-6 h-[1px] bg-[var(--color-ink)] group-hover:bg-[var(--color-gold)] group-hover:scale-125 transition-all duration-300 origin-left" />
