...
export const metadata: Metadata = buildMetadata({
  title: 'Trading',
  description: 'Sourcing what your project actually needs. Importing the systems that build Qatar.',
      ...
      <div className="text-[var(--color-bone)] min-h-screen relative z-10">
        ...
        <section className="relative h-[80svh] w-full px-[5vw] flex flex-col justify-end pb-[10vh] pt-32">
          <div className="absolute inset-0 z-0 bg-[var(--color-ink)]">
            <Image
              src="/images/pillars/trading.jpg"
          ...
          <div className="relative z-10 max-w-5xl">
            <span className="font-mono text-xs uppercase tracking-[0.2em] opacity-80 block mb-4 text-[var(--color-gold)]">
              Importing the systems that build Qatar.
            </span>
            <SplitText
              as="h1"
              className="font-display text-[clamp(3.5rem,8vw,7rem)] leading-[1.05] tracking-[-0.02em] mb-6 [text-shadow:0_1px_8px_rgba(11,18,32,0.5)]"
            >
              Sourcing what your project actually needs.
            </SplitText>
              ...
              {[
                {
                  ...
                  desc: 'Bulk supply of civil and structural inputs tailored to project specification.',
                },
                {
                  title: 'MEP equipment',
                  desc: 'Specialized mechanical, electrical, and plumbing hardware.',
                },
                {
                  title: 'Specialist tooling',
                  desc: 'Precision tools and industrial safety gear for demanding sites.',
                },
                {
                  title: 'Logistics & customs',
                  desc: 'End-to-end import clearance and site delivery across Qatar.',
                },
              ].map((item, i) => (
                <div key={i} className="group flex flex-col gap-5 border-t border-[var(--color-bone)]/20 pt-8 hover:border-[var(--color-gold)] transition-colors duration-300">
                  <div className="w-6 h-[1px] bg-[var(--color-bone)] group-hover:bg-[var(--color-gold)] group-hover:scale-125 transition-all duration-300 origin-left" />
        ...
        <section className="px-[5vw] py-[14vh] text-center flex flex-col items-center">
          <h2 className="font-display text-[clamp(2.5rem,5vw,4rem)] leading-[1.1] tracking-[-0.02em] mb-10 max-w-[20ch]">
            Project requires trading? Let's scope it.
          </h2>
